...
export const showSuccessModal = (title?: string, descrip?: string) => {
  Swal.fire({
    html: `
      <div class="my-custom-modal flex flex-col text-center items-center justify-start gap-4">
...
export const showSuccessAlert = (descrip?: string) => {
  Swal.fire({
    html: `
    <div class="my-custom-modal flex items-center text-center justify-start gap-2   py-1 text-[14px]">
...
export const showErrorAlert = (descrip?: string) => {
  Swal.fire({
    html: `
    <div class="my-custom-modal flex items-center text-center justify-start gap-2   py-1 text-[14px] text-[#f27020]">
