...
export function ExitModal({ isOpen, onClose }: ExitModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-in fade-in duration-200">
      <Card className="w-full max-w-sm bg-white/95 backdrop-blur-sm shadow-2xl rounded-2xl border-0 transform animate-in zoom-in-95 duration-300">
        <div className="p-8">
          {/* Modal Icon */}
          <div className="text-center mb-6">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-2">অ্যাপ থেকে বের হন</h3>
            <p className="text-lg text-center text-gray-700 leading-relaxed">আপনি কি অ্যাপ থেকে বের হতে চাচ্ছেন?</p>
          </div>
