...
import { ArrowLeft, Home, Plus, LogOut, FileText, Calendar, List, BookOpen } from "lucide-react"
...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100 relative pb-20">
      ...
      <div className="bg-white/95 backdrop-blur-sm shadow-lg p-3 sm:p-4 flex items-center relative z-10">
        <Link href="/">
          <ArrowLeft className="w-5 h-5 sm:w-6 sm:h-6 text-gray-600 hover:text-blue-600 transition-colors" />
        </Link>
        <div className="flex-1 flex justify-center">
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            />
            <div>
              <div className="text-blue-600 font-bold text-base sm:text-lg">EDULIFE</div>
      ...
      <div className="p-3 sm:p-4 relative z-10">
        <Card className="p-4 sm:p-6 bg-white/95 backdrop-blur-sm shadow-xl rounded-2xl border-0 transform hover:scale-105 transition-all duration-300">
          <div className="flex items-center space-x-3 sm:space-x-4">
            <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-purple-400 to-purple-600 rounded-full flex items-center justify-center shadow-lg flex-shrink-0">
              <span className="text-white font-bold text-xl sm:text-2xl">র</span>
            </div>
            <div className="flex-1 min-w-0">
              <h2 className="font-bold text-lg sm:text-xl text-gray-800 mb-1 truncate">তোফাজ্জল হোসেন রাসেল</h2>
      ...
      <div className="p-3 sm:p-4 grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 relative z-10">
        <Link href="/quiz">
          <Card className="p-6 sm:p-8 bg-white/95 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-300 cursor-pointer rounded-2xl border-0 transform hover:scale-105 hover:-translate-y-1">
            <div className="text-center">
              ...
              <p className="font-semibold text-gray-800 text-base sm:text-lg">নতুন ফরম</p>
            </div>
          </Card>
        </Link>
        ...
        <Link href="/todays-collection">
          <Card className="p-6 sm:p-8 bg-white/95 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-300 cursor-pointer rounded-2xl border-0 transform hover:scale-105 hover:-translate-y-1">
            <div className="text-center">
              ...
              <p className="font-semibold text-gray-800 text-base sm:text-lg">আজকের সংগ্রহ</p>
            </div>
          </Card>
        </Link>
        ...
        <Link href="/all-forms">
          <Card className="p-6 sm:p-8 bg-white/95 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-300 cursor-pointer rounded-2xl border-0 transform hover:scale-105 hover:-translate-y-1">
            <div className="text-center">
              ...
              <p className="font-semibold text-gray-800 text-base sm:text-lg">সব ফরম</p>
            </div>
          </Card>
        </Link>
        ...
        <Card className="p-6 sm:p-8 bg-white/95 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-300 cursor-pointer rounded-2xl border-0 transform hover:scale-105 hover:-translate-y-1">
          <div className="text-center">
            ...
            <p className="font-semibold text-gray-800 text-base sm:text-lg">তত্ত্ব পাঠন</p>
          </div>
        </Card>
      </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-2xl z-20">
        <div className="grid grid-cols-3">
          ...
          <Link href="/quiz" className="p-3 sm:p-4 text-center hover:bg-blue-500 transition-colors duration-200">
